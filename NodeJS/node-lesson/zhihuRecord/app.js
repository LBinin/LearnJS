...
setInterval(() => {
  ...
  .end(function (err, sres) {
    ...
    console.log(user_name + '任务 1 ：第 ' + i++ + ' 次得分：' + score + '，排名：' + rank + '，总得分：' + game_record)
  })
}, 5000)