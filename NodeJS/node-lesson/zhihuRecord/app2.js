...
setInterval(() => {
  score = 160 + Math.ceil(15 * Math.random())
  superagent
  .post('https://2017.zhihu.com/api/star/microbe/game')
  ...
  .end(function (err, sres) {
    ...
    console.log(user_name + '任务 2 ：第 ' + i++ + ' 次得分：' + score + '，排名：' + rank + '，总得分：' + game_record)
  })
}, 5000)